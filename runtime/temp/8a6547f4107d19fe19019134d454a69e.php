<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\filesys\public/../application/index\view\index\upload.html";i:1540266652;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	...
	.del-item{
		...
		line-height:30px;
		margin:10px 0;
		background:url('/public/static/img/icon/error.png') no-repeat 0px center;
